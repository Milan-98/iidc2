...
const DjArtistLineupLightbox = () => {
  ...
  return (
    <>
      {/* DJ Section */}
      <section className=" px-4 pb-14 pt-5  md:px-6  lg:mx-auto  lg:w-[70rem] lg:px-0">
        <h3
          className={`mt-10 text-4xl text-[2.5rem] font-black -tracking-tighter text-[#DF9627] lg:px-0 ${poppinsBold.className} `}
        >
          DJ
        </h3>
        ...
        >
          <section id="0" className="grid gap-1 md:gap-2">
            ...
            <h5
              id="0"
              className="text-center text-sm md:text-base md:font-bold lg:text-2xl"
            >
              Julian Duke
            </h5>
          </section>
