...
const HeroOfAllPages: React.FC<HeroOfAllPagesProps> = ({
  ...
  return (
    <section className="bg-[#00000048] bg-HeroOfItinerary bg-cover  bg-left bg-no-repeat px-6 pb-14 pt-28 text-white bg-blend-multiply md:bg-cover md:bg-left md:px-16  md:pb-16 lg:bg-left-top  lg:px-28 lg:py-40">
