...
const HeroOfAllPages: React.FC<HeroOfAllPagesProps> = ({
  ...
  return (
    <section className="bg-[#00000048] bg-HeroOfAllPages bg-cover bg-fixed bg-left bg-repeat-y  px-6 pb-14 pt-28 text-white bg-blend-multiply md:bg-left md:px-16 md:pb-16 lg:bg-left-top lg:px-0 lg:py-40 ">
