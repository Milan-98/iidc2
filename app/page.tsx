      ...
      <main className="">
        ...
        <section className="bg-[#00000048] bg-HomePageHero bg-cover bg-repeat-y bg-blend-multiply  md:h-[100dvh] lg:h-fit ">
          <section className="pt-28 md:pt-52 lg:px-32 lg:pt-36">
            ...
            <Link
              href={"/"}
              className="group mx-auto mt-4 flex w-40 items-center justify-center rounded-full bg-black py-3 font-semibold -tracking-tighter   text-white duration-700  hover:bg-[#DF9627] lg:mx-0 lg:mt-6   lg:w-44 lg:py-4"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-0 translate-x-full rotate-45  fill-white transition-all duration-700 ease-out group-hover:mr-1 group-hover:w-fit group-hover:-translate-x-0 "
                width="24"
                height="24"
              >
          ...
          <section className="mt-10 grid gap-10 fill-white pb-14 text-[#DF9627] lg:mt-40 lg:grid-cols-3 lg:gap-28  lg:px-32">
            {/* 1 */}
            <section className="">
              <h3 className=" flex items-center  justify-center gap-2 text-2xl font-semibold lg:justify-normal">
                {" "}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="24"
              ...
              <h5 className="mt-1 text-center  text-lg text-white lg:ml-8 lg:text-start">
                17-19 May, 2024
              </h5>
            </section>
            {/* 2 */}
            <section className=" ">
              <h3 className=" flex items-center justify-center gap-2  text-2xl font-semibold lg:justify-start">
                <svg
                  fill="#000000"
                  version="1.1"
                  id="Capa_1"
                  ...
                  className="w-[1.32rem] fill-white"
		...
		c-27.114,0-49.191-22.076-49.191-49.191C148.658,110.2,170.734,88.138,197.849,88.138z"
              ...
              <p className="mt-1 px-6 text-center text-lg text-white lg:text-start">
            ...
            <section>
              ...
              <h5 className="mt-1 text-center text-lg text-white lg:text-start ">
                1200 Available
              </h5>
            </section>
          </section>
        ...
        <section className="bg-black px-6 py-16 sm:px-8 md:px-12 lg:px-28">
          ...
          <p className="text-white lg:pr-40 lg:text-[1.06rem]">
            ...
            the opportunity to learn from the very best. Buy tickets today to
        ...
        <section className="bg-[#00000048] bg-HomePageVideoSectionBg  bg-cover bg-fixed bg-center bg-repeat-y py-16 bg-blend-multiply lg:grid lg:grid-flow-col lg:grid-cols-3 lg:gap-20 lg:px-20 lg:py-20">
          ...
          <section className="mt-10 px-6 sm:px-8 md:px-12 lg:col-span-2 lg:ml-10 lg:mt-0 lg:px-0 lg:pr-20">
            ...
            <p className="text-white  lg:text-[1.06rem]">
              ...
              cornerstone of the Indian dance community, drawing dancers and
              enthusiasts from across the nation and around the world. With each
              passing year, IIDC continues to raise the bar in the realm of
            ...
            <p className="mt-3 text-white lg:mt-4  lg:text-[1.06rem]">
              ...
              culture. Explore a world of sultry salsa, passionate bachata, and
