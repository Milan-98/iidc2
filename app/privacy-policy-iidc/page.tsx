...
export const metadata: Metadata = {
  title:
    "IIDC Privacy Policy - India International Dance Congress Data Protection",
  description:
    "Discover our Privacy Policy: Learn how we collect, use, and protect your info when using our website or participating in events at IIDC.",
  keywords: [
    "IIDC Privacy Policy",
