  ...
  return (
    <main>
      ...
      <section className="px-6 py-10 md:py-14 lg:py-20">
        ...
        <section className="lg:w-[70rem] lg:mx-auto lg:grid lg:grid-flow-col lg:grid-cols-2 ">
        ...
        <section className=" mt-14 md:mt-16 lg:mt-0">
          ...
          <p className="mt-2">
            ...
            in Latin rhythms. Choose from our range of options, secure your spot
            today, and get ready to move to the rhythm of IIDC!
          </p>
