    ...
    <main>
      ...
      <section className="px-6 py-10 md:px-10 lg:grid lg:grid-flow-col lg:grid-cols-3 lg:gap-10 lg:px-24 lg:py-20">
        <section className=" col-span-2">
          ...
          <p className="mt-5  lg:text-[1.07rem]">
            ...
            annual extravaganza, IIDC transcends the boundaries of ordinary
            dance events, offering a multifaceted experience that combines the
            joy of movement with the magic of Latin rhythms. IIDC&apos;s mission
            is simple yet profound: to unite people through dance, to inspire
          ...
          <p className="mt-3 lg:mt-4 lg:text-[1.07rem]">
            ...
            Moreover, IIDC is a testament to the unifying power of dance, where
            people from all walks of life come together, breaking down barriers,
            and dancing to the same irresistible beat. IIDC is not just an
            event; it&apos;s an unforgettable journey into the heart of Latin
            dance, where every step is a celebration of life, rhythm, and
            community.
          </p>
        </section>
        <Image
      ...
      <section className={`bg-[#00000048] bg-fixed bg-center lg:text-[1.06rem] bg-EthosBg bg-cover px-6 py-10 text-[#d2d2d2] bg-blend-multiply sm:px-10 sm:py-14 md:px-14 lg:px-24 `}>
        ...
        <p className=" text-center">
          IIDC&apos;s legacy is founded upon its commitment to excellence. Year
          after year, it has consistently brought together some of the
        ...
        <section className="lg:grid lg:grid-cols-2 lg:gap-16  lg:px-20 lg:py-10">
          <section className="">
            ...
            <p className="mt-2 text-center">
              Embracing the rich tapestry of dance forms from across the globe,
              IIDC strives to showcase the beauty and diversity of dance styles,
              from classical to contemporary, traditional to fusion.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-center">
              ...
              together dancers, choreographers, instructors, and enthusiasts to
              share their love for dance, forge lifelong connections, and
              inspire one another.
            </p>
          </section>
        </section>
